export interface DailyLog {
  ...
  macrofactor_synced_at: string | null;
...
export interface SyncStatus {
  ...
  oura_client_id: boolean;
  whoop_client_id: boolean;
  withings_client_id: boolean;
  last_oura_sync: string | null;
  last_whoop_sync: string | null;
  last_chrono_sync: string | null;
  last_macrofactor_sync: string | null;
  last_withings_sync: string | null;
  last_ladder_sync: string | null;
}

export type ServiceId = "oura" | "whoop" | "withings" | "chronometer" | "macrofactor" | "ladder";
